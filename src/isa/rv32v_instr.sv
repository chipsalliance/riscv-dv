...
`DEFINE_VA_INSTR(VSLL,      VA_FORMAT,  SHIFT,      RVV, {VV, VX, VI}, UIMM)
`DEFINE_VA_INSTR(VSRL,      VA_FORMAT,  SHIFT,      RVV, {VV, VX, VI}, UIMM)
`DEFINE_VA_INSTR(VSRA,      VA_FORMAT,  SHIFT,      RVV, {VV, VX, VI}, UIMM)
`DEFINE_VA_INSTR(VNSRL,     VA_FORMAT,  SHIFT,      RVV, {WV, WX, WI}, UIMM)
`DEFINE_VA_INSTR(VNSRA,     VA_FORMAT,  SHIFT,      RVV, {WV, WX, WI}, UIMM)
...
`DEFINE_VA_INSTR(VSSRL,   VA_FORMAT, SHIFT,      RVV, {VV, VX, VI}, UIMM)
`DEFINE_VA_INSTR(VSSRA,   VA_FORMAT, SHIFT,      RVV, {VV, VX, VI}, UIMM)
`DEFINE_VA_INSTR(VNCLIPU, VA_FORMAT, ARITHMETIC, RVV, {WV, WX, WI}, UIMM)
`DEFINE_VA_INSTR(VNCLIP,  VA_FORMAT, ARITHMETIC, RVV, {WV, WX, WI}, UIMM)
...
`DEFINE_VA_INSTR(VSLIDEUP,     VA_FORMAT,  ARITHMETIC, RVV, {VX, VI}, UIMM)
`DEFINE_VA_INSTR(VSLIDEDOWN,   VA_FORMAT,  ARITHMETIC, RVV, {VX, VI}, UIMM)
...
`DEFINE_VA_INSTR(VRGATHER,     VA_FORMAT,  ARITHMETIC, RVV, {VV, VX, VI}, UIMM)
