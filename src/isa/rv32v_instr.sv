...
`DEFINE_VA_INSTR(VSETVLI,  VSET_FORMAT, CSR, RVV)
`DEFINE_VA_INSTR(VSETIVLI, VSET_FORMAT, CSR, RVV, {}, UIMM)
`DEFINE_VA_INSTR(VSETVL,   VSET_FORMAT, CSR, RVV)
...
`DEFINE_VA_INSTR(VLSEGE_V,    VL_FORMAT,  LOAD,  RVV)
`DEFINE_VA_INSTR(VSSEGE_V,    VS_FORMAT,  STORE, RVV)
`DEFINE_VA_INSTR(VLSEGEFF_V,  VL_FORMAT,  LOAD,  RVV)
`DEFINE_VA_INSTR(VLSSEGE_V,   VLS_FORMAT, LOAD,  RVV)
`DEFINE_VA_INSTR(VSSSEGE_V,   VSS_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VLUXSEGEI_V, VLX_FORMAT, LOAD,  RVV)
`DEFINE_VA_INSTR(VLOXSEGEI_V, VLX_FORMAT, LOAD,  RVV)
`DEFINE_VA_INSTR(VSUXSEGEI_V, VSX_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VSOXSEGEI_V, VSX_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VLRE_V,      VLR_FORMAT, LOAD,  RVV)
`DEFINE_VA_INSTR(VSR_V,       VSR_FORMAT, STORE, RVV)
...
`DEFINE_VA_INSTR(VFCLASS_V,         VS2_FORMAT, ARITHMETIC, RVV)
