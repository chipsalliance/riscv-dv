...
#    self.illegal_instr = riscv_illegal_instr()
    ...
    def gen_instr(self, is_main_program, no_branch = 1):
        ...
        self.instr_stream.gen_instr(no_branch = no_branch, no_load_store=0,
...
#    allow_branch &= not cfg.no_branch_jump
        ...
        problem.addVariable(stk_len, range(
            cfg.min_stack_len_per_program, cfg.min_stack_len_per_program))
...
#    self.instr_stack_enter.cfg = cfg
    ...
    def gen_stack_exit_instr(self):
        ...
        instr_stack_exit.gen_pop_stack_instr(
            self.program_stack_len, self.instr_stack_enter.saved_regs)
