...
def exp_compare_trace_csv(csv1, csv2, name1, name2, log,
                          in_order_mode = 1,
                          coalescing_limit = 0,
                          verbose = 0,
  ...
  with open(csv1, "r") as fd1, open(csv2, "r") as fd2:
    instr_trace_1 = []
    instr_trace_2 = []
    trace_csv_1 = ExpRiscvInstructionTraceCsv(fd1)
    trace_csv_2 = ExpRiscvInstructionTraceCsv(fd2)
...
def main():
  ...
  # Compare trace CSV
  exp_compare_trace_csv(args.csv_file_1, args.csv_file_2,
